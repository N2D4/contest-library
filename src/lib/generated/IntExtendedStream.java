...
public interface IntExtendedStream extends IntStream {
    ...
    static   IntExtendedStream ofLazySpliterator(Lazy<? extends Spliterator.OfInt> spliterator, boolean parallel) {
        return new IntExtendedStreamImpl(spliterator, parallel);
    }
}
