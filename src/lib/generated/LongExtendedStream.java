...
public interface LongExtendedStream extends LongStream {
    ...
    static   LongExtendedStream ofLazySpliterator(Lazy<? extends Spliterator.OfLong> spliterator, boolean parallel) {
        return new LongExtendedStreamImpl(spliterator, parallel);
    }
}
