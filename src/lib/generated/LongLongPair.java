...
public class LongLongPair extends Tuple implements LongLongMap.Entry {
    ...
    public <A1, B1> Pair<A1, B1> map(LongObjFunc<A1> mapA, LongObjFunc<B1> mapB) {
        return new Pair<A1, B1>(mapA.apply(this.a), mapB.apply(this.b));
    }

    public <R> R match(LongLongObjBiFunc<R> func) {
        return func.apply(a, b);
    }

    public void match(LongLongBiCons func) {
        func.accept(a, b);
    }
    ...
    public boolean equals(Object other) {
        ...
        LongLongPair pair = (LongLongPair) other;
